          ...
          <div className="space-y-4">
            ...
            <div className="relative rounded-3xl overflow-hidden h-[500px] group bg-slate-200 shadow-inner">
              ...
              <button
                ...
                className="absolute left-6 top-1/2 -translate-y-1/2 bg-white/90 p-3 rounded-full shadow-xl opacity-0 group-hover:opacity-100 transition hover:bg-white hover:text-lime-600"
              >
              ...
              <button
                ...
                className="absolute right-6 top-1/2 -translate-y-1/2 bg-white/90 p-3 rounded-full shadow-xl opacity-0 group-hover:opacity-100 transition hover:bg-white hover:text-lime-600"
              >
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
              {apartment.images.map((img, idx) => (
                <button
                  ...
                  className={`relative flex-shrink-0 w-28 h-20 rounded-xl overflow-hidden border-2 transition-all ${activeImgIndex === idx ? "border-lime-500 scale-95 shadow-md" : "border-transparent opacity-60 hover:opacity-100"}`}
                >
                  <img
                    src={img}
          ...
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4">
              <div className="space-y-2">
                <span className="inline-block bg-lime-100 text-lime-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-y border-slate-200">
              ...
              <div className="flex flex-col items-center text-center gap-1 border-x border-slate-100">
                <Bath className="w-6 h-6 text-lime-600" />
                <p className="font-bold text-lg">{apartment.bathrooms} Bains</p>
              </div>
              <div className="flex flex-col items-center text-center gap-1">
                <Square className="w-6 h-6 text-lime-600" />
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                Ce magnifique appartement situé à {apartment.neighborhood} offre
                un cadre de vie exceptionnel. L'espace a été conçu pour
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 sticky top-24 space-y-8">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-1.5">
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:ring-2 focus:ring-lime-500 focus:bg-white outline-none transition"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  rows="4"
                  className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:ring-2 focus:ring-lime-500 focus:bg-white outline-none transition resize-none"
                  placeholder="Bonjour, je souhaiterais planifier une visite..."
                ></textarea>
              </div>
              <button className="w-full bg-lime-500 text-white py-4 rounded-xl font-bold hover:bg-lime-600 transition shadow-lg shadow-lime-200 active:scale-[0.98]">
                Contacter le propriétaire
              </button>
            </form>

            <div className="pt-6 border-t border-slate-100 flex items-center justify-around text-slate-400">
              <button className="flex flex-col items-center gap-1 hover:text-lime-600 transition group">
                <Phone className="w-5 h-5 group-hover:scale-110 transition" />
                <span className="text-[10px] uppercase font-bold">Appeler</span>
              </button>
              <button className="flex flex-col items-center gap-1 hover:text-lime-600 transition group">
